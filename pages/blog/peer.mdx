...
solution for [this StackOverflow post](https://stackoverflow.com/questions/386792/in-java-swing-how-do-you-get-a-win32-window-handle-hwnd-reference-to-a-window)
uses this solution, which doesn't even compile in JDK 21+.
```java
